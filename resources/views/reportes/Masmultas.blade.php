    ...
    <div class="row col-xs-12" style="margin-bottom:10px;">
        <div class="row col-sm-12">
            ...
            <table class="table table-hover table-striped" style="margin-top: 1.5rem;">
                <thead>
                    <tr>
                        <th class="text-center" colspan="4">Alumnos con más multas en el periodo:</th>
                        <th class="text-center">
                            <a href="#" class="btn btn-primary" style="background-color: #6d356c; " data-toggle="" data-target="#">Imprimir PDF</a>
                        </th>
                    </tr>
                    <tr>
